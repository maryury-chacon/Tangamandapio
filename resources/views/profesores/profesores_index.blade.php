                ...
                <div class="table-responsive-sm -mr-2 col-md-10"
                    ...
                    <table name="tabla_prove"  class="table table-responsive table-bordered">
                        <tr>
                            ...
                            <th colspan="7">Profesores <a style="color: white;margin-left: 720px; text-align: center;" href="{{route("profesor.create")}}">
                        ...
                        @foreach($profesores as $item=>$profesor)
                            <tr id="resultados">
                                ...
                                <td style="font: caption; text-align: center">{{$profesor->identidad}}</td>
                                <td style="font: caption; text-align: left">{{$profesor->direccion}}</td>
