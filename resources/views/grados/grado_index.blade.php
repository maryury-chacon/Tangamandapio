...
@section('content')
                ...
                <div class="table-responsive-sm -mr-2 col-md-10"
                    ...
                    <table name="tabla_prove"  class="table table-responsive table-bordered">
                        <tr>
                            ...
                            <th colspan="7">Grado <a style="color: white;margin-left: 720px; text-align: center;" href="{{route("grado.create")}}">
                        ...
                        <tbody>
                        @foreach($grados as $item=>$grado)
                            <tr id="resultados">
                                <td style="font: caption; text-align: center">{{$grado->id}}</td>
                                <td style="font: caption; text-align: left">{{$grado->jornada}}</td>
                                <td style="font: caption; text-align: center">{{$grado->seccion}}</td>
                                <td style="font: caption; text-align: center">{{$grado->aula}}</td>
                                <td style="text-align: center">
                                    <a class="btn btn-" style="background: #151E6D" href="{{route("grado.show",["id"=>$grado->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill=" #FFFFFF" class="bi bi-layers-fill" viewBox="0 0 16 16">
                                ...
                                <td style="text-align: center">
                                    <a class="btn btn" style="background: #00796B" href="{{route("grado.edit",["id"=>$grado->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill=" #FFFFFF" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                ...
                                <td style="text-align: center">
                                    <a type="button" class="btn btn" style="background: #C62828" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{$grado->id}}" onclick="recibir('{{$grado->id}}')">
                    ...
                    @else
                        <div class="alert alert d-flex align-items-center" role="alert" style="margin-top: 15px; background: #C62828; color: #FFFFFF">
                            ...
                            <div>
                                No hay grados agregados aún, presiona el botón de agregar.
                            </div>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>¿Está de acuerdo con eliminar el grado seleccionado?</p>
                            </div>
    ...
    <script>
        function recibir(numero) {
            var id = numero;
            document.formulario_eliminar.action = "/grados/" + id + "/destroy";
        }
    </script>
