...
@section('content')
        ...
        <div class="row">
                ...
                <div class="table-responsive-sm -mr-2 col-md-10"
                    ...
                    <table name="tabla_prove"  class="table table-responsive table-bordered">
                        <tr>
                            ...
                            <th colspan="7">Grado <a style="color: white;margin-left: 720px; text-align: center;" href="{{route("estudiante.create")}}">
                        ...
                        @foreach($grados as $item=>$grado)
                            <tr id="resultados">
                                ...
                                <td style="font: caption; text-align: left">{{$grado->Aula}}</td>
            ...
            <center>
                <div class="col-md-5" style="text-align: center; margin: 0 auto; margin-bottom: 10px; margin-top: 12px;">
                    {{ $grado->links('pagination::bootstrap-4') }}
                </div>
            </center>
        </div>
    </div>
    ...
    <script>
        function recibir(numero) {
            var id = numero;
            document.formulario_eliminar.action = "/grado/" + id + "/destroy";
        }
    </script>
